...
const apibarbar = 'Apikey Ribut';
const BotName = 'SPS2007-BOT'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'FN:Agus\n' // Nama kamu
            + 'ORG:VVIPINDO;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=6282167459979:+62 821-6745-9979\n' //Nomor whatsapp kamu
            + 'END:VCARD'
const
{
WAConnection,
...
if (text.includes('.tagme')) {
 ...
 const options = {
       text: `@${nomor.split("6282167459979@s.whatsapp.net")[0]} Hai kak 🤗`,
